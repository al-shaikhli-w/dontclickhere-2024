...
<section class="py-11 customer_feedback-section <?php echo $attributes['layoutStyle'] ?>">
        ...
        <div class="customer_feedbacks swiper-wrapper w-full h-full">
            ...
            if ($posts->have_posts()) :
                while ($posts->have_posts()) :
                    ...
                    if ($attributes['layoutStyle'] === 'style-2') { ?>
                        hallo layout 2
                        <div class="customer_feedback swiper-slide bg-white border border-gray-400 rounded-md">
                            <div class="excerpt"><?php the_excerpt(); ?></div>
                            <div class="customer_feedback-wrapper">
                                <div class="avatar relative inline-flex ring-primary ring-offset-base-100 w-24 rounded-full ring ring-offset-2">
                                    <div class="customer_feedback-image w-24 rounded-full overflow-hidden">
                                        <img src="<?php echo $imageUrl ?>" class="w-full h-full object-cover" alt="<?php the_title(); ?>" />
                                    </div>
                                </div>
