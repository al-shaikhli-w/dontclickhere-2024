<?php
	if (have_rows('why_us_cards')) : ?>
        <div class="why_us_cards overflow-hidden">
					...
					<?php
						while (have_rows('why_us_cards')) : the_row();
                            ...
                            <div class="swiper-slide why-us-card">
                                <img src="<?php
									echo wp_get_attachment_image_url($icon, 'full'); ?>" alt="<?php
									echo $heading; ?>">
                                <h3 class="heading"><?php
										echo acf_esc_html($heading); ?></h3>
                                <p><?php
										echo acf_esc_html(get_sub_field('content')); ?></p>
                            </div>
						<?php
						endwhile; ?>
                </div>
