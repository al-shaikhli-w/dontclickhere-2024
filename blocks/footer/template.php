                        ...
                        while (have_rows("social_media")) : the_row();
                            ...
                            <li>
                                <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>">
                                    <?php
                                    if(strtolower($link_title) === 'instagram') {?>
